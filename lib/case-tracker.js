...
import { pushCaseAction } from "./ucat-client.js";
...
export async function syncActionToUcat(action) {
  try {
    ...
    if (ucatId && ucatId !== action.ucatId) {
      await db.update(caseActions).set({ ucatId }).where(eq(caseActions.id, action.id));
    }
  } catch (e) {
...
export async function recordAction(
  ...
  performedBy,
  data = {},
  { categoryCode = null, categoryExtra = null } = {}
) {
